    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:url" content="https://suniket.cz/kapela/lukas-janata" />
                ...
                <link rel="canonical" href="https://suniket.cz/kapela/lukas-janata" />
            </Helmet>
            <BreadcrumbJsonLd items={[{ name: "Domů", path: "/" }, { name: data.name, path: "/kapela/lukas-janata" }]} />
            <Template {...data} />
        </>
    );
}
