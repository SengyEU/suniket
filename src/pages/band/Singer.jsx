    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:url" content="https://suniket.cz/kapela/victor-hrazdil" />
                ...
                <link rel="canonical" href="https://suniket.cz/kapela/victor-hrazdil" />
            </Helmet>
            <BreadcrumbJsonLd items={[{ name: "Domů", path: "/" }, { name: data.name, path: "/kapela/victor-hrazdil" }]} />
            <Template {...data} />
        </>
    );
}
